...
const SingleProductPageFav = ({ data }) => {
  ...
  return (
    <div>
      <button
        onClick={() => FavAdder()}
        className="cursor-pointer flex justify-center items-center text-center rounded-md p-2 w-full bg-blue-500 transition-all duration-500 hover:bg-blue-600 text-white"
      >
